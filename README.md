...
This repository contains the package which provides functionality for analytics collection.
...
In order to install and use the linked dependencies for `pkg-analytics` the following command can be used:
